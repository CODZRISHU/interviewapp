...
import { LayoutDashboard, BarChart3, User, LogOut, CreditCard, Receipt, Sparkles } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <aside className="h-full w-64 bg-[#08080A] border-r border-white/10 flex flex-col shrink-0 select-none shadow-[10px_0_30px_rgba(0,0,0,0.5)] z-20" data-testid="sidebar">
      {/* Brand Header */}
      <div className="h-20 flex items-center gap-3 px-6 border-b border-white/10 cursor-pointer" onClick={() => navigate('/dashboard')}>
